...
public class RabbitMQConfig {
    ...
    public static final String WEBHOOK_QUEUE_NAME = "webhooks.main";
    ...
    public Queue mainQueue() {
        return new Queue(WEBHOOK_QUEUE_NAME, true, false, false,
                Map.of(
    ...
    public Binding mainBinding() {
        return BindingBuilder.bind(mainQueue()).to(mainExchange()).with(WEBHOOK_QUEUE_NAME);
    }
}